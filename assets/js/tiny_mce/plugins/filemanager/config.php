...
//$mcFileManagerConfig['general.tools'] = "imagemanager,createdir,createdoc,refresh,zip,upload,edit,rename,cut,copy,paste,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
	$mcFileManagerConfig['general.tools'] = "imagemanager,createdir,refresh,upload,edit,rename,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
...
$mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/upload/Files'; // absolute or relative from this script path.
...
//$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv";
	$mcFileManagerConfig['filesystem.extensions'] = 'docx,csv,doc,xls,ppt,gif,jpeg,jpg,png,tiff,bmp,pdf,rar,zip,rtf,swf,fla,flv,txt,wav,mp3,mp4,avi,mpeg,mpg';
...
//$mcFileManagerConfig['upload.extensions'] = 'csv,doc,xls,ppt,gif,jpeg,jpg,png,tiff,bmp,pdf,rar,zip,rtf,swf,fla,flv,txt,wav,mp3,mp4,avi,mpeg,mpg';
	$mcFileManagerConfig['upload.extensions'] = $mcFileManagerConfig['filesystem.extensions'];
...
//$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,mp3,txt,zip";
	$mcFileManagerConfig['download.extensions'] = $mcFileManagerConfig['upload.extensions'];
