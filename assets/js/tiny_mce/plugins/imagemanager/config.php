...
$mcImageManagerConfig['general.tools'] = "upload,refresh,insert,delete,edit,preview,filemanager"; // "filemanager" button if you have "filemanager.urlprefix" configured.
...
//$mcImageManagerConfig['filesystem.path'] = '/upload/Images/'; // absolute or relative from this script path, optional.
$mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/upload/Images/'; // absolute or relative from this script path, required.
...
$mcImageManagerConfig['upload.max_width'] = '1024'; // Only if force_width_height is true
$mcImageManagerConfig['upload.max_height'] = '1024'; // Only if force_width_height is true
