...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function drawCalendar() {
            ...
            var $containerHtml = $('<div class="zabuto_calendar calendar__blockTable" id="' + $calendarElement.attr('id') + '"></div>');
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthCell = $('<th class="calendar__month arno"></th>').append($prevMonthNav);
            var $nextMonthCell = $('<th class="calendar__month arno"></th>').append($nextMonthNav);
            ...
            var $currMonthCell = $('<th colspan="5" class="calendar__month arno"></th>');
        ...
        function appendDayOfWeekHeader($calendarElement, $tableObj) {
            if ($calendarElement.data('showDays') === true) {
                ...
                $(dowLabels).each(function (index, value) {
                    $dowHeaderRow.append('<td>' + value + '</td>');
                });
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        $dowRow.append('<td class="calendar__date"></td>');
                    } else {
                        ...
                        var $dowElement = $('<td class="calendar__date" id="' + dateId + '"></td>');
