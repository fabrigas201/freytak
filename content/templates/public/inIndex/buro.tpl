	...
	<div class="container container_inner">
		<div class="container__row">
			<div class="container__col text">
				<div class="treatment">
					<h2 class="title">
						<span class="title__text arno">Обращение управляющего партнера</span>
					</h2>
					<div class="container__row">
				...
				<div class="info">
					<h2 class="title">
						<span class="title__text arno">инфоцентр</span>
						<a href="{get_url(config('lang.weblang'),'news/infocentr')}" class="title__link title__link_insert linkTriangle">смотреть новости</a>
					</h2>
					...
					<div class="container__row">
						<div class="container__col info__item">
							<a href="{get_url(config('lang.weblang'),'news/novosti-byuro')}" class="info__title arno">
								...
								<span class="info__titleWrap">новости бюро</span>
							</a>
						...
						<div class="container__col info__item">
							<a href="/{config('lang.weblang')}/news/pravovye-novosti" class="info__title arno">
								...
								<span class="info__titleWrap">Правовые новости</span>
							</a>
						...
						<div class="container__col info__item">
							<a href="{get_url(config('lang.weblang'),'articles/analitika')}" class="info__title arno">
								...
								<span class="info__titleWrap">аналитика</span>
							</a>
